    ...
    **kwargs,
    ...
    for epoch in range(num_epoch):
        ...
        for img, label in train_data:
            ...
            logger.add_scalar("train_loss", loss.item(), epoch, global_step)
            logger.add_scalar("train_accuracy", accuracy, epoch, global_step)
            global_step += 1
        ...
        logger.add_scalar("train_accuracy", epoch_train_acc, epoch, global_step)
        epoch_val_acc = torch.as_tensor(metrics["val_acc"]).mean()
        logger.add_scalar("val_accuracy", epoch_val_acc, epoch, global_step)
